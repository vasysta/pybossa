...
from factories import (AppFactoryMemory, BlogpostFactoryMemory,
                       UserFactoryMemory, reset_all_pk_sequences)
from helper.repositories import clean_all_memory_repos



class TestUserAuthorization(object):
    ...
    def test_admins_can_update_any_user(self):
        ...
        himself = UserFactoryMemory.create()
        other_user = UserFactoryMemory.create()
