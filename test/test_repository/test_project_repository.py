...
class TestMemoryProjectRepositoryForProjects(object):

    project_repo = memo_project_repo

    def setUp(self):
        self.project_repo.clean()
    ...
    def test_get_by(self):
        ...
        project = AppFactoryMemory.create(name='My Project', short_name='myproject')
    ...
    def test_get_by_returns_none_if_no_project(self):
        ...
        AppFactoryMemory.create(name='My Project', short_name='myproject')
    ...
    def get_all_returns_list_of_all_projects(self):
        ...
        projects = AppFactoryMemory.create_batch(3)
    ...
    def test_filter_by_one_condition(self):
        ...
        AppFactoryMemory.create_batch(3, allow_anonymous_contributors=False)
        should_be_missing = AppFactoryMemory.create(allow_anonymous_contributors=True)
    ...
    def test_filter_by_multiple_conditions(self):
        ...
        AppFactoryMemory.create_batch(2, allow_anonymous_contributors=False, hidden=0)
        project = AppFactoryMemory.create(allow_anonymous_contributors=False, hidden=1)
    ...
    def test_save(self):
        ...
        project = AppFactoryMemory.build()
        assert self.project_repo.get(project.id) is None
    ...
    #     project = AppFactoryMemory.build(name=None)
    ...
    def test_update(self):
        ...
        project = AppFactoryMemory.create(description='this is a project')
        project.description = 'the description has changed'
...
class TestMemoryProjectRepositoryForCategories(object):
    ...
    def test_get_category_returns_category(self):
        ...
        category = CategoryFactoryMemory.create()
    ...
    def test_get_category_by(self):
        ...
        category = CategoryFactoryMemory.create(name='My Cat', short_name='mycat')
    ...
    def test_get_category_by_returns_none_if_no_category(self):
        ...
        CategoryFactoryMemory.create(name='My Project', short_name='mycategory')
    ...
    def get_all_returns_list_of_all_categories(self):
        ...
        categories = CategoryFactoryMemory.create_batch(3)
    ...
    def test_filter_categories_by_one_condition(self):
        ...
        CategoryFactoryMemory.create_batch(3, description='generic category')
        should_be_missing = CategoryFactoryMemory.create(description='other category')
    ...
    def test_save_category(self):
        ...
        category = CategoryFactoryMemory.build()
        assert self.project_repo.get(category.id) is None
    ...
    #     category = CategoryFactoryMemory.build(name=None)
    ...
    def test_save_category_only_saves_categories(self):
        ...
        bad_object = AppFactoryMemory.build()
    ...
    def test_update_category(self):
        ...
        category = CategoryFactoryMemory.create(description='this is a category')
        category.description = 'the description has changed'
