...
AppFactoryMemory, TaskFactoryMemory, TaskRunFactoryMemory, memo_task_repo
...
class TestMemoryTaskRepositoryForTaskQueries(object):

    task_repo = memo_task_repo

    def setUp(self):
        self.task_repo.clean()
    ...
    def test_get_task_by(self):
        ...
        task = TaskFactoryMemory.create(state='done')
    ...
    def test_get_task_by_returns_none_if_no_task(self):
        ...
        TaskFactoryMemory.create(state='done')
    ...
    def test_filter_tasks_by_no_matches(self):
        ...
        TaskFactoryMemory.create(state='done', n_answers=17)
    ...
    def test_filter_tasks_by_one_condition(self):
        ...
        TaskFactoryMemory.create_batch(3, state='done')
        should_be_missing = TaskFactoryMemory.create(state='ongoing')
    ...
    def test_filter_tasks_by_multiple_conditions(self):
        ...
        TaskFactoryMemory.create(state='done', n_answers=17)
        task = TaskFactoryMemory.create(state='done', n_answers=99)
    ...
    def test_filter_tasks_support_yield_option(self):
        ...
        tasks = TaskFactoryMemory.create_batch(2, state='done')
...
class TestMemoryTaskRepositoryForTaskrunQueries(object):
    ...
    def test_get_task_run_returns_task_run(self):
        ...
        taskrun = TaskRunFactoryMemory.create()
    ...
    def test_get_task_run_by(self):
        ...
        taskrun = TaskRunFactoryMemory.create(info='info')
    ...
    def test_get_task_run_by_returns_none_if_no_task_run(self):
        ...
        TaskRunFactoryMemory.create(info='info')
    ...
    def test_filter_task_runs_by_one_condition(self):
        ...
        TaskRunFactoryMemory.create_batch(3, info='info')
        should_be_missing = TaskFactoryMemory.create(info='other info')
    ...
    def test_filter_task_runs_by_multiple_conditions(self):
        ...
        TaskRunFactoryMemory.create(info='info', user_ip='8.8.8.8')
        taskrun = TaskRunFactoryMemory.create(info='info', user_ip='1.1.1.1')
    ...
    def test_filter_task_runs_support_yield_option(self):
        ...
        task_runs = TaskRunFactoryMemory.create_batch(2, info='info')
    ...
    def test_count_task_runs_with_one_condition(self):
        ...
        TaskRunFactoryMemory.create_batch(3, info='info')
        should_be_missing = TaskRunFactoryMemory.create(info='other info')
...
class TestMemoryTaskRepositorySaveDeleteUpdate(object):
    ...
    #     task = TaskFactoryMemory.build(app_id=None, app=None)
    ...
    def test_update_task(self):
        ...
        task = TaskFactoryMemory.create(state='ongoing')
        task.state = 'done'
    ...
    def test_delete_all_deletes_many_taskruns(self):
        ...
        taskruns = TaskRunFactoryMemory.create_batch(2)
    ...
    def test_update_tasks_redundancy_changes_all_project_tasks_redundancy(self):
        ...
        TaskFactoryMemory.create_batch(2, app=project, n_answers=1)
    ...
    def test_update_tasks_redundancy_updates_state_when_incrementing(self):
        ...
        project = AppFactoryMemory.create()
        tasks = TaskFactoryMemory.create_batch(2, app=project, n_answers=2)
        TaskRunFactoryMemory.create_batch(2, task=tasks[0])
        tasks[0].state = 'completed'
        self.task_repo.update(tasks[0])
    ...
    def test_update_tasks_redundancy_updates_state_when_decrementing(self):
        ...
        tasks = TaskFactoryMemory.create_batch(2, app=project, n_answers=2)
        TaskRunFactoryMemory.create_batch(2, task=tasks[0])
        TaskRunFactoryMemory.create(task=tasks[1])
        tasks[0].state = 'completed'
        self.task_repo.update(tasks[0])
