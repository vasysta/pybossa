...
from factories import BlogpostFactory, BlogpostFactoryMemory, memo_blog_repo
...
class TestMemoryBlogRepository():

    blog_repo = memo_blog_repo

    def setUp(self):
        self.blog_repo.clean()
    ...
    def test_get_by(self):
        ...
        blogpost = BlogpostFactoryMemory.create(title='My blog', body='myblogpost')
    ...
    def test_get_by_returns_none_if_no_blogpost(self):
        ...
        BlogpostFactoryMemory.create(title='My blog', body='myblogpost')
    ...
    def test_filter_by_one_condition(self):
        ...
        BlogpostFactoryMemory.create_batch(3, title='my blogpost')
        should_be_missing = BlogpostFactoryMemory.create(title='another blogpost')
    ...
    def test_filter_by_multiple_conditions(self):
        ...
        BlogpostFactoryMemory.create(title='my blogpost', body='body')
        blogpost = BlogpostFactoryMemory.create(title='my blogpost', body='other body')
    ...
    def test_save(self):
        ...
        blogpost = BlogpostFactoryMemory.build()
        assert self.blog_repo.get(blogpost.id) is None
    ...
    #     blogpost = BlogpostFactoryMemory.build(title=None)
    ...
    def test_update(self):
        ...
        blogpost = BlogpostFactoryMemory.create(body='this is a blogpost')
        blogpost.body = 'new content'
